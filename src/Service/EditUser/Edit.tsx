...
interface EditUserFormProps {
    userEditDTO: EditUserDTO | null;  // Thay đổi từ userEditDTO[] thành userEditDTO
}

const EditUserForm = () => {  // Thay đổi từ user thành userEditDTO
    ...
    return (
        <>
            <Form onFinish={handleSubmit(onSubmit)} className='AddForm'>
                ...
                <Form.Item label="Chức Vụ" name="age" rules={[{ required: true, message: 'Please enter age' }]}>
                    <InputNumber style={{ marginLeft: '40px', width: '250px' }} />
                </Form.Item>
                ...
                <Form.Item>
                    ...
                    <Button style={{ marginLeft: '20px', marginTop: '20px', borderColor: 'revert-layer' }} onClick={() => navigate('/services')}>Cancel</Button>
